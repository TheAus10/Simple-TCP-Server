...
int main(int argc, char *argv[])
{
	...
	char svr_reply[256];		// string for server messages 
	...
	printf("\n\n*** Connected ***\n\n");
	printf("Welcome to the Word Count Server!\n");
 	printf("\tEnter sentences and the server will send\n");
	printf("\tback a processed output. Type \"quit\" to\n");
